# Install script for directory: /home/brain/toy_ros_space/src/g2o_test/Thirdparty/g2o_lib/g2o/examples/interactive_slam/g2o_incremental
...
FILE(INSTALL DESTINATION "/usr/local/lib" TYPE SHARED_LIBRARY FILES "/home/brain/toy_ros_space/src/g2o_test/Thirdparty/g2o_lib/lib/libg2o_incremental.so")
  IF(EXISTS "$ENV{DESTDIR}/usr/local/lib/libg2o_incremental.so" AND
     NOT IS_SYMLINK "$ENV{DESTDIR}/usr/local/lib/libg2o_incremental.so")
    FILE(RPATH_REMOVE
         FILE "$ENV{DESTDIR}/usr/local/lib/libg2o_incremental.so")
...
IF(NOT CMAKE_INSTALL_COMPONENT OR "${CMAKE_INSTALL_COMPONENT}" STREQUAL "Unspecified")
  ...
  IF (CMAKE_ERROR_ON_ABSOLUTE_INSTALL_DESTINATION)
    message(FATAL_ERROR "ABSOLUTE path INSTALL DESTINATION forbidden (by caller): ${CMAKE_ABSOLUTE_DESTINATION_FILES}")
  ENDIF (CMAKE_ERROR_ON_ABSOLUTE_INSTALL_DESTINATION)
FILE(INSTALL DESTINATION "/usr/local/bin" TYPE EXECUTABLE FILES "/home/brain/toy_ros_space/src/g2o_test/Thirdparty/g2o_lib/bin/g2o_incremental")
  IF(EXISTS "$ENV{DESTDIR}/usr/local/bin/g2o_incremental" AND
     NOT IS_SYMLINK "$ENV{DESTDIR}/usr/local/bin/g2o_incremental")
    FILE(RPATH_REMOVE
         FILE "$ENV{DESTDIR}/usr/local/bin/g2o_incremental")
...
FILE(INSTALL DESTINATION "/usr/local/include/g2o/examples/interactive_slam/g2o_incremental" TYPE FILE FILES
    "/home/brain/toy_ros_space/src/g2o_test/Thirdparty/g2o_lib/g2o/examples/interactive_slam/g2o_incremental/linear_solver_cholmod_online.h"
    "/home/brain/toy_ros_space/src/g2o_test/Thirdparty/g2o_lib/g2o/examples/interactive_slam/g2o_incremental/graph_optimizer_sparse_incremental.h"
    "/home/brain/toy_ros_space/src/g2o_test/Thirdparty/g2o_lib/g2o/examples/interactive_slam/g2o_incremental/g2o_incremental_api.h"
    )
ENDIF(NOT CMAKE_INSTALL_COMPONENT OR "${CMAKE_INSTALL_COMPONENT}" STREQUAL "Unspecified")
